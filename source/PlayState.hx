...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['zoy', 0.9], //From 80% to 89%
		['poyoyo!', 1], //From 90% to 99%
		['poyoyoyoyo!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function update(elapsed:Float)
	{
		...
		if(songScore == 0) {
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%' + ' | Rating: ' + ratingName + '';
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%' + ' | Rating: ' + ratingName + ' [' + ratingFC + ']';//peeps wanted no integer rating
		}if(botplayTxt.visible) {
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%' + ' | Rating: ' + ratingName + ' [BOTPLAY]';
		}
